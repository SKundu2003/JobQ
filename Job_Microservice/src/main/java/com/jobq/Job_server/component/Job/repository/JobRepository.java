...
public interface JobRepository extends JpaRepository<JobEntity, Long> {
    ...
    String FETCH_INFO_OF_RELEVANT_JOBS = "SELECT "+ Meta.SHORT_INFO_OF_JOB_COLUMNS+ " FROM "+ Meta.JOB_TABLE_NAME +" , "
    ...
    String COUNT_RELEVANT_JOBS = "SELECT "+ Meta.SHORT_INFO_OF_JOB_COLUMNS+ " FROM "+ Meta.JOB_TABLE_NAME +" , "
            + Meta.JOB_AND_SKILL_MAPPING_TABLE_NAME +" , "
            + Meta.JOB_AND_DOMAIN_MAPPING_TABLE_NAME +" , "
            + Meta.SKILL_TABLE_NAME +" , "
            + Meta.DOMAIN_TABLE_NAME +
    ...
    Optional<List<JobEntity>> fetchRelevantJobs(@Param("domainIds") List<Long> domainIds, @Param("skillIds") List<Long> skillIds,
